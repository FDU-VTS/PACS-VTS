...
class Instance(DicomModel):
    ...
    color_space = models.CharField(verbose_name=_('Color Space'), max_length=50, blank=True, null=True)
    photometric_interpretation = models.CharField(verbose_name=_('Photometric Interpretation'), max_length=50,
    ...
    largest_image_pixel_value = models.PositiveIntegerField(verbose_name=_('Largest Image Pixel Value'), blank=True,
                                                            null=True)
    pixel_aspect_ratio = models.CharField(verbose_name=_('Pixel Aspect Ratio'), max_length=50, blank=True, null=True)
    pixel_spacing = models.CharField(verbose_name=_('Pixel Spacing'), max_length=50, blank=True, null=True)
