                            ...
                            <Row gutter={16} style={ {background: 'grey' , padding: '40px'}}>
                                ...
                                <Col span={8}>
                                    <Card title="Series " bordered={false}>
                                        ...
                                        <h5>Images Count: {study.series_images_count}
                                        <a href={`/series/${study.series_id}`}>
                                        <input style={{float:'right',color:'white',backgroundColor:'darkblue', fontWeight:'bold', border:'none'}} 
                                        class="layui-btn btn01" type="button" value="OPEN" />
                                        </a>
                                        </h5>                                       
                                    </Card>
                                </Col>
